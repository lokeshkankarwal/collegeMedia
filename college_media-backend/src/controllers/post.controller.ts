import type { Request, Response } from "express"; // 🛠️ Fixed: Explicitly imported Express Request
...
export const getPosts = async (
  req: Request, // 🛠️ Fixed: Now uses the Express Request type interface
  res: Response
): Promise<void> => {
  try {
...
export const getComments = async (
  req: Request, // 🛠️ Fixed: Uses standard Express Request type signature
  res: Response
): Promise<void> => {
  try {
    const postId = req.params.postId;
